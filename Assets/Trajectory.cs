...
public class Trajectory : MonoBehaviour
{
    ...
    // Inisiasi status pantulan lintasan, yang hanya akn ditampilkan jika lintasan bertumbukan dengan objek tertentu
    void Update()
    {
        ...
        {
            // Jika terjadi tumbukan, dan tumbukan tersebu tidak dengan bola
            // karena aris lntasan digambardari titik tengah bola
            if (circleCastHit2D.collider !=null && circleCastHit2D.collider.GetComponent<BallControl>() == null)
            {
                ...
                // yaitu sebuah titik yang di-offset dari titik tumbukan berdasar vektor normal titi tersebut sebesar
                // jari-jari bola.
